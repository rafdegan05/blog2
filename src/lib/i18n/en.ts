export const en = {
  ...
  userProfile: {
    ...
    noComments: "This user hasn't made any comments yet.",
    commentedOn: "commented on",
    about: "About",
    bio: "Bio",
    noBio: "This user hasn't written a bio yet.",
    achievements: "Achievements",
    achieveFirstPost: "First Post — Published their first article",
    achieveProlific: "Prolific Writer — Published 10+ articles",
    achieveCommenter: "Active Commenter — Left 10+ comments",
    achievePodcaster: "Podcaster — Published their first podcast",
    noAchievements: "No achievements yet. Start contributing!",
    info: "Account Info",
    joined: "Joined",
    role: "Role",
    postedBy: "Posted by",
  ...
  podcasts: {
    ...
    transcriptPlaceholder: "Paste or type the episode transcript here...",
    transcriptHint: "Supports .txt, .srt, .vtt and .md files. You can also type or paste directly.",
    importTranscript: "Import file",
    generateTranscript: "Generate",
    generatingTranscript: "Generating…",
    generateTranscriptError: "Transcription failed. Make sure an audio file is uploaded.",
    ...
    addLanguageHint: "Select a language above to add a transcript.",
    episodeLanguageLabel: "Episode Language",
    selectLanguage: "Select language…",
    detectLanguage: "Detect",
    detectLanguageHint: "Auto-detect the spoken language from the audio using AI",
    detectLanguageError: "Language detection failed. Make sure an audio file is uploaded.",
    hostedBy: "Hosted by",
    deleteBtn: "Delete",
    deleteConfirmShort: "Delete this podcast?",
    confirmYes: "Yes, delete",
    saveChanges: "Save Changes",
    formSubtitle: "Fill in the details for your new episode",
    editSubtitle: "Update your episode details",
    sectionDetails: "Episode Details",
    sectionMedia: "Media",
    sectionMetadata: "Metadata",
    optionalBadge: "Optional",
    publishHint: "Make this episode visible to everyone",
    characters: "characters",
    captionFormat: "Format",
    captionEditorView: "Editor",
    captionSourceView: "Source",
    captionSearchPlaceholder: "Search captions…",
    captionEmptyState: "No captions yet. Import a file, generate from audio, or add manually.",
    captionAddCue: "Add caption",
    captionStart: "Start",
    captionEnd: "End",
    captionText: "Text",
    captionSeekTo: "Jump to this time",
    captionSetFromPlayhead: "Set from playhead",
    captionInsertAfter: "Insert after",
    captionSplit: "Split",
    captionMerge: "Merge with next",
    captionDelete: "Delete",
    captionApplyChanges: "Apply changes",
    captionCueCount: "captions",
    captionLanguage: "Language",
    captionDownloadAs: "Download as",
  },
