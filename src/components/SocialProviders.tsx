...
const SUPPORTED_PROVIDERS = [
  {
    ...
    className: "btn w-full gap-2 bg-[#24292f] hover:bg-[#1b1f23] text-white border-none",
  },
  {
    id: "google",
    name: "Google",
    ...
    className: "btn w-full gap-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300",
  },
  {
    id: "keycloak",
    name: "Keycloak",
    ...
    className: "btn w-full gap-2 bg-[#4d4d4d] hover:bg-[#3a3a3a] text-white border-none",
  },
] as const;
